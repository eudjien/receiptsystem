...
import ru.clevertec.checksystem.webmvcjdbc.mapper.discount.receipt.SimplePercentageReceiptDiscountMapper;
...
@Component
public class SimplePercentageReceiptDiscountDao extends Dao<SimplePercentageReceiptDiscount, Long> {

    private final static String SQL_FIND_BY_ID = "" +
            "SELECT parent.id, parent.description, child.percent, parent.dependent_discount_id " +
            "FROM " + Entities.Table.SIMPLE_PERCENTAGE_RECEIPT_DISCOUNT + " child " +
    ...
    private final static String SQL_DELETE_ALL = "" +
            ...
            "WHERE type = " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_DISCOUNT;

    private final static String SQL_DELETE_BY_ID = "" +
            "DELETE FROM " + Entities.Table.RECEIPT_DISCOUNTS + " " +
            "WHERE type = " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_DISCOUNT + " AND id = :id";

    private final static String SQL_DELETE_ALL_BY_ID = "" +
            "DELETE FROM " + Entities.Table.RECEIPT_DISCOUNTS + " " +
            "WHERE type = " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_DISCOUNT + " AND id IN(:ids)";
    ...
    private final static String SQL_UPDATE_CHILD_BY_ID = "" +
            "UPDATE " + Entities.Table.SIMPLE_PERCENTAGE_RECEIPT_DISCOUNT + " " +
            "SET percent = :percent " +
            "WHERE id = :id";

    private final static String SQL_INSERT_PARENT = "" +
            "INSERT INTO " + Entities.Table.RECEIPT_DISCOUNTS + "(id, description, type) " +
            "VALUES(:id, :description, " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_DISCOUNT + ")";

    private final static String SQL_INSERT_CHILD = "" +
            "INSERT INTO " + Entities.Table.SIMPLE_PERCENTAGE_RECEIPT_DISCOUNT + "(id, percent) " +
            "VALUES(:id, :percent)";

    private final SimplePercentageReceiptDiscountMapper rowMapper;

    @Autowired
    public SimplePercentageReceiptDiscountDao(DataSource dataSource, SimplePercentageReceiptDiscountMapper rowMapper) {
        super(new NamedParameterJdbcTemplate(dataSource));
        this.rowMapper = rowMapper;
    }

    @Override
    public List<SimplePercentageReceiptDiscount> findAll() {
        return getJdbcTemplate().query(SQL_FIND_ALL, rowMapper);
    }

    @Override
    public List<SimplePercentageReceiptDiscount> findAllById(Collection<Long> ids) {
    ...
    @Override
    public SimplePercentageReceiptDiscount findById(Long id) {
    ...
    @Override
    public int delete(SimplePercentageReceiptDiscount entity) {
        var parameters = new MapSqlParameterSource().addValue("id", entity.getId());
        return getJdbcTemplate().update(SQL_DELETE_BY_ID, parameters);
    }

    @Override
    public <S extends SimplePercentageReceiptDiscount> int deleteAll(Collection<S> entities) {
    ...
    @Override
    public SimplePercentageReceiptDiscount update(SimplePercentageReceiptDiscount entity) {
    ...
    @Override
    public <S extends SimplePercentageReceiptDiscount> List<SimplePercentageReceiptDiscount> updateAll(Collection<S> entities) {
    ...
    @Override
    public SimplePercentageReceiptDiscount add(SimplePercentageReceiptDiscount entity) {
        var keyHolder = new GeneratedKeyHolder();
        getJdbcTemplate().update(SQL_INSERT_PARENT, createMapSqlParameterSourceParent(entity), keyHolder, new String[]{"id"});
        getJdbcTemplate().update(SQL_INSERT_CHILD, createMapSqlParameterSourceChild(entity), keyHolder, new String[]{"id"});
        return findById(Objects.requireNonNull(keyHolder.getKey()).longValue());
    }

    @Override
    public <S extends SimplePercentageReceiptDiscount> List<SimplePercentageReceiptDiscount> addAll(Collection<S> entities) {
    ...
    private static MapSqlParameterSource[] createBatchMapSqlParameterSourceParent(Collection<? extends ReceiptDiscount> entities) {
        return entities.stream().map(SimplePercentageReceiptDiscountDao::createMapSqlParameterSourceParent)
                .toArray(MapSqlParameterSource[]::new);
    }

    private static MapSqlParameterSource[] createBatchMapSqlParameterSourceChild(Collection<? extends SimplePercentageReceiptDiscount> entities) {
        return entities.stream().map(SimplePercentageReceiptDiscountDao::createMapSqlParameterSourceChild)
                .toArray(MapSqlParameterSource[]::new);
    }
    ...
    private static MapSqlParameterSource createMapSqlParameterSourceChild(SimplePercentageReceiptDiscount entity) {
        return new MapSqlParameterSource()
                .addValue(Entities.Column.ID, entity.getId())
