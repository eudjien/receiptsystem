...
import ru.clevertec.checksystem.webmvcjdbc.mapper.discount.receiptItem.SimplePercentageReceiptItemDiscountMapper;
...
@Component
public class SimplePercentageReceiptItemDiscountDao extends Dao<SimplePercentageReceiptItemDiscount, Long> {

    private final static String SQL_FIND_BY_ID = "" +
            "SELECT parent.id, parent.description, child.percent, parent.dependent_discount_id " +
            "FROM " + Entities.Table.SIMPLE_PERCENTAGE_RECEIPT_ITEM_DISCOUNT + " child " +
    ...
    private final static String SQL_DELETE_ALL = "" +
            ...
            "WHERE type = " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_ITEM_DISCOUNT;

    private final static String SQL_DELETE_BY_ID = "" +
            "DELETE FROM " + Entities.Table.RECEIPT_ITEM_DISCOUNTS + " " +
            "WHERE type = " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_ITEM_DISCOUNT + " AND id = :id";

    private final static String SQL_DELETE_ALL_BY_ID = "" +
            "DELETE FROM " + Entities.Table.RECEIPT_ITEM_DISCOUNTS + " " +
            "WHERE type = " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_ITEM_DISCOUNT + " AND id IN(:ids)";
    ...
    private final static String SQL_UPDATE_CHILD_BY_ID = "" +
            "UPDATE " + Entities.Table.SIMPLE_PERCENTAGE_RECEIPT_ITEM_DISCOUNT + " " +
            "SET percent = :percent " +
            "WHERE id = :id";

    private final static String SQL_INSERT_PARENT = "" +
            "INSERT INTO " + Entities.Table.RECEIPT_ITEM_DISCOUNTS + "(id, description, type) " +
            "VALUES(:id, :description, " + Entities.DiscriminatorValues.SIMPLE_PERCENTAGE_RECEIPT_ITEM_DISCOUNT + ")";

    private final static String SQL_INSERT_CHILD = "" +
            "INSERT INTO " + Entities.Table.SIMPLE_PERCENTAGE_RECEIPT_ITEM_DISCOUNT + "(id, percent) " +
            "VALUES(:id, :percent)";

    private final SimplePercentageReceiptItemDiscountMapper rowMapper;

    @Autowired
    public SimplePercentageReceiptItemDiscountDao(DataSource dataSource, SimplePercentageReceiptItemDiscountMapper rowMapper) {
        super(new NamedParameterJdbcTemplate(dataSource));
        this.rowMapper = rowMapper;
    }

    @Override
    public List<SimplePercentageReceiptItemDiscount> findAll() {
        return getJdbcTemplate().query(SQL_FIND_ALL, rowMapper);
    }

    @Override
    public List<SimplePercentageReceiptItemDiscount> findAllById(Collection<Long> ids) {
    ...
    @Override
    public SimplePercentageReceiptItemDiscount findById(Long id) {
    ...
    @Override
    public int delete(SimplePercentageReceiptItemDiscount entity) {
        var parameters = new MapSqlParameterSource().addValue(Entities.Column.ID, entity.getId());
        return getJdbcTemplate().update(SQL_DELETE_BY_ID, parameters);
    }

    @Override
    public <S extends SimplePercentageReceiptItemDiscount> int deleteAll(Collection<S> entities) {
    ...
    @Override
    public SimplePercentageReceiptItemDiscount update(SimplePercentageReceiptItemDiscount entity) {
    ...
    @Override
    public <S extends SimplePercentageReceiptItemDiscount> List<SimplePercentageReceiptItemDiscount> updateAll(Collection<S> entities) {
    ...
    @Override
    public SimplePercentageReceiptItemDiscount add(SimplePercentageReceiptItemDiscount entity) {
    ...
    @Override
    public <S extends SimplePercentageReceiptItemDiscount> List<SimplePercentageReceiptItemDiscount> addAll(Collection<S> entities) {
        return entities.stream().map(this::add).collect(Collectors.toList());
    }

    private static MapSqlParameterSource[] createBatchMapSqlParameterSourceParent(Collection<? extends SimplePercentageReceiptItemDiscount> entities) {
        return entities.stream().map(SimplePercentageReceiptItemDiscountDao::createMapSqlParameterSourceParent)
                .toArray(MapSqlParameterSource[]::new);
    }

    private static MapSqlParameterSource[] createBatchMapSqlParameterSourceChild(Collection<? extends SimplePercentageReceiptItemDiscount> entities) {
        return entities.stream().map(SimplePercentageReceiptItemDiscountDao::createMapSqlParameterSourceChild)
                .toArray(MapSqlParameterSource[]::new);
    }
    ...
    private static MapSqlParameterSource createMapSqlParameterSourceChild(SimplePercentageReceiptItemDiscount entity) {
        return new MapSqlParameterSource()
                .addValue(Entities.Column.ID, entity.getId())
