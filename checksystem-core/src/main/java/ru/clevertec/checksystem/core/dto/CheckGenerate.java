...
public class CheckGenerate {
    ...
    private Collection<CheckItemGenerate> checkItemGenerates = new SinglyLinkedList<>();

    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    public CheckGenerate() {
    }
    ...
    public CheckGenerate(
            ...
            @JsonProperty("checkItemGenerates") Collection<CheckItemGenerate> checkItemGenerates) {
        this(id, name, description, address, cashier, phoneNumber, date);
        this.discountIds = discountIds;
        this.checkItemGenerates = checkItemGenerates;
    }
    ...
    public Collection<CheckItemGenerate> getCheckItemGenerates() {
        return checkItemGenerates;
    }

    public void setCheckItems(Collection<CheckItemGenerate> checkItemGenerates) {
        this.checkItemGenerates = checkItemGenerates != null ? checkItemGenerates : new SinglyLinkedList<>();
    }
}
